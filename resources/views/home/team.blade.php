...
<body>
    ...
    <div class="container-fluid sm:container-fluid">
        <div class="lg:h-screen xs:h-60">

            <div id="animation-carousel" class="relative" data-carousel="static">
                <!-- Carousel wrapper -->
                <div class="relative lg:h-full h-60 overflow-hidden">
                    <!-- Item 1 -->
        ...
        <div class="h-screen">
            <div class="grid lg:grid-cols-1 xs:grid-cols-1">
                <img class=" lg:h-[30rem] xs:h-60 w-full" src="https://shop.static.ingka.ikea.com/revamp/armchairs-and-chaise-longues_fu006.jpg" />
            </div>
            
           <div class="grid lg:grid-cols-2 xs:grid-cols-1">
               <div class="pt-10 lg:pl-20">
